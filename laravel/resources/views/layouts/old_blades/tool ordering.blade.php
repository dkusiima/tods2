        ...
        <div class="col-xs-12 col-sm-8 col-md-4 col-sm-offset-2 col-md-offset-4">
            <div class="panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title"> TOOL ORDERING</PICKUP> </h3>
                </div>
                    ...
                    <form role="form">
                        ...
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <th class="table-lines text-center"  rowspan="6"> Quantity Ordered </th>
                            </tr>
                            </thead>
                            <tbody>
                            <tr>
                                <td class="table-lines"> &nbsp</td>
                                <td class="table-lines"> Hospital</td>
                                <td class="table-lines"> HC IV</td>
                                <td class="table-lines"> HC III </td>
                                <td class="table-lines"> HC II </td>
                                <td class="table-lines"> Clinic </td>
                                <td class="table-lines"> Total </td>
                            </tr>
                            <tr>
